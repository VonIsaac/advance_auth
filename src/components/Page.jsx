            ...
            <main className=' text-white flex justify-center items-center h-screen' >
                <div className=' p-5 rounded-sm'>
                    <div className=' text-center tracking-wide text-base/6'>
                        <h1 className='text-5xl font-bold tracking-wider mb-2.5'>Welcome {user?.user.username} to the User&apos;s Page&apos;s </h1>
                        ...
                        <p className=' font-medium mb-2.5'>Role: {user?.user.role}</p>
